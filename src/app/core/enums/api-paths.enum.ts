export enum ApiPaths {
  ...
  GET_CONNECTION_INFO = '/api/v1/server_connect/get_connection_info',
  ...
  LOOKUP_OS_FIRMWARE = '/api/v1/os_firmware/',
  LOOKUP_OS_FIRMWARE_IMPORT = '/api/v1/os_firmware/import',
  LOOKUP_OS_FIRMWARE_EXPORT = '/api/v1/os_firmware/export',
  LOOKUP_OS_FIRMWARE_DELETE = '/api/v1/os_firmware/delete',
